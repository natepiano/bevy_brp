...
// Import individual BRP handlers and their parameter types
use crate::brp_tools::component::bevy_get::{BevyGet, GetParams};
use crate::brp_tools::component::bevy_insert::{BevyInsert, InsertParams};
use crate::brp_tools::component::bevy_list::{BevyList, ListParams};
use crate::brp_tools::component::bevy_mutate_component::{
    BevyMutateComponent, MutateComponentParams,
};
use crate::brp_tools::component::bevy_query::{BevyQuery, QueryParams};
use crate::brp_tools::component::bevy_remove::{BevyRemove, RemoveParams};
use crate::brp_tools::discovery::bevy_registry_schema::{BevyRegistrySchema, RegistrySchemaParams};
use crate::brp_tools::discovery::bevy_rpc_discover::{BevyRpcDiscover, RpcDiscoverParams};
use crate::brp_tools::dynamic::brp_execute::{BrpExecute, ExecuteParams};
use crate::brp_tools::entity::bevy_destroy::{BevyDestroy, DestroyParams};
use crate::brp_tools::entity::bevy_reparent::{BevyReparent, ReparentParams};
use crate::brp_tools::entity::bevy_spawn::{BevySpawn, SpawnParams};
use crate::brp_tools::extras::brp_extras_discover_format::{
    BrpExtrasDiscoverFormat, DiscoverFormatParams,
};
use crate::brp_tools::extras::brp_extras_screenshot::{BrpExtrasScreenshot, ScreenshotParams};
use crate::brp_tools::extras::brp_extras_send_keys::{BrpExtrasSendKeys, SendKeysParams};
use crate::brp_tools::extras::brp_extras_set_debug_mode::{
    BrpExtrasSetDebugMode, SetDebugModeParams,
};
use crate::brp_tools::resource::bevy_get_resource::{BevyGetResource, GetResourceParams};
use crate::brp_tools::resource::bevy_insert_resource::{BevyInsertResource, InsertResourceParams};
use crate::brp_tools::resource::bevy_list_resources::{BevyListResources, ListResourcesParams};
use crate::brp_tools::resource::bevy_mutate_resource::{BevyMutateResource, MutateResourceParams};
use crate::brp_tools::resource::bevy_remove_resource::{BevyRemoveResource, RemoveResourceParams};
use crate::brp_tools::{
    BevyGetWatch, BevyListWatch, BrpListActiveWatches, BrpStopWatch, GetWatchParams,
    ListWatchParams, StopWatchParams,
};
use crate::field_extraction::{ParameterName, ResponseFieldName};
use crate::log_tools::{
...
use crate::tool::parameters_from_schema;
...
pub fn get_all_tool_definitions() -> Vec<ToolDef> {
    vec![
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<DestroyParams>),
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<GetParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<GetResourceParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<InsertParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<InsertResourceParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ListParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ListResourcesParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<MutateComponentParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<MutateResourceParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<QueryParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<RegistrySchemaParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<RemoveParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<RemoveResourceParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ReparentParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<RpcDiscoverParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<SpawnParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ExecuteParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<DiscoverFormatParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ScreenshotParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<SendKeysParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<SetDebugModeParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<GetWatchParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ListWatchParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<DeleteLogsParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            handler:           HandlerFn::local_with_port(
                app_tools::create_launch_bevy_app_handler(),
            ),
            parameter_builder: Some(parameters_from_schema::<LaunchBevyAppParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<LaunchBevyExampleParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<StopWatchParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ListLogsParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ReadLogParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<SetTracingLevelParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<StatusParams>),
            response_format:   ResponseSpecification {
        ...
        ToolDef {
            ...
            parameter_builder: Some(parameters_from_schema::<ShutdownParams>),
            response_format:   ResponseSpecification {
